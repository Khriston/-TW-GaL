...
<body>
    ...
    <main class="lmain">
			<form class="login" method="post"> 
				...
				<div id=updateName>
					<label >Name:</label>
					<input type="text" required placeholder="Enter your password" name="updateName"/>
				</div>
				...
				<div id=updateEmail>
					<label >Email:</label>
					<input type="email" required placeholder="Enter your password" name="updateEmail"/>
				</div>
				<div id=updateScore>
					<label >Score:</label>
					<input type="text" required placeholder="Enter your password" name="updateScore"/>
				</div>
